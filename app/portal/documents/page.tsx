...
export default async function PortalDocumentsPage({
  ...
  // RLS already enforces tenant scoping; we additionally exclude internal docs
  // here so they don't appear in the UI even if a policy slipped (defense in
  // depth per CLAUDE.md rule 3).
  let query = supabase
    .from("documents")
    .select(
      `id, file_name, owner_type, owner_id, size_bytes, mime_type, expiration_date,
    ...
    <div>
      ...
      <div className="surface mb-6 px-4 py-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <form action="/portal/documents" method="get" className="flex items-center gap-2">
        ...
        <EmptyState
          ...
          description={
            hasFilters
              ...
              : "Documents uploaded by Dastify staff to your providers, enrollments, or group will appear here once they're marked public."
          }
        />
      ) : (
        <>
            ...
            <table className="data-table">
              <thead>
                <tr>
                  ...
                  <th>Expires</th>
                  <th className="w-[110px]">Uploaded</th>
                </tr>
              </thead>
              <tbody>
                {documents!.map((d) => {
