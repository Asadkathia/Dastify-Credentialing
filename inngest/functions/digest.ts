 ...
 *
 * TODO(v1.1): roll up status changes + new comments + upcoming recreds in the
 * past 7 days for each client whose digest_email_frequency = 'weekly', then
 * send via lib/email/client.ts using digestEmail template.
 */
